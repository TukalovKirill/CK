...
export function TextbookIcon({ size = 20, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      <path d="M7.5 15.75C7.5 15.551 7.579 15.36 7.72 15.22C7.86 15.079 8.051 15 8.25 15H11.25C11.449 15 11.64 15.079 11.78 15.22C11.921 15.36 12 15.551 12 15.75C12 15.949 11.921 16.14 11.78 16.28C11.64 16.421 11.449 16.5 11.25 16.5H8.25C8.051 16.5 7.86 16.421 7.72 16.28C7.579 16.14 7.5 15.949 7.5 15.75ZM7.5 12.75C7.5 12.551 7.579 12.36 7.72 12.22C7.86 12.079 8.051 12 8.25 12H15.75C15.949 12 16.14 12.079 16.28 12.22C16.421 12.36 16.5 12.551 16.5 12.75C16.5 12.949 16.421 13.14 16.28 13.28C16.14 13.421 15.949 13.5 15.75 13.5H8.25C8.051 13.5 7.86 13.421 7.72 13.28C7.579 13.14 7.5 12.949 7.5 12.75ZM7.5 9.75C7.5 9.551 7.579 9.36 7.72 9.22C7.86 9.079 8.051 9 8.25 9H15.75C15.949 9 16.14 9.079 16.28 9.22C16.421 9.36 16.5 9.551 16.5 9.75C16.5 9.949 16.421 10.14 16.28 10.28C16.14 10.421 15.949 10.5 15.75 10.5H8.25C8.051 10.5 7.86 10.421 7.72 10.28C7.579 10.14 7.5 9.949 7.5 9.75ZM7.5 6.75C7.5 6.551 7.579 6.36 7.72 6.22C7.86 6.079 8.051 6 8.25 6H15.75C15.949 6 16.14 6.079 16.28 6.22C16.421 6.36 16.5 6.551 16.5 6.75C16.5 6.949 16.421 7.14 16.28 7.28C16.14 7.421 15.949 7.5 15.75 7.5H8.25C8.051 7.5 7.86 7.421 7.72 7.28C7.579 7.14 7.5 6.949 7.5 6.75Z" fill="currentColor"/>
      <path d="M4.5 0H19.5C20.296 0 21.059 0.316 21.621 0.879C22.184 1.441 22.5 2.204 22.5 3V21C22.5 21.796 22.184 22.559 21.621 23.121C21.059 23.684 20.296 24 19.5 24H4.5C3.704 24 2.941 23.684 2.379 23.121C1.816 22.559 1.5 21.796 1.5 21V19.5H3V21C3 21.398 3.158 21.779 3.439 22.061C3.721 22.342 4.102 22.5 4.5 22.5H19.5C19.898 22.5 20.279 22.342 20.561 22.061C20.842 21.779 21 21.398 21 21V3C21 2.602 20.842 2.221 20.561 1.939C20.279 1.658 19.898 1.5 19.5 1.5H4.5C4.102 1.5 3.721 1.658 3.439 1.939C3.158 2.221 3 2.602 3 3V4.5H1.5V3C1.5 2.204 1.816 1.441 2.379 0.879C2.941 0.316 3.704 0 4.5 0Z" fill="currentColor"/>
...
export function QuizIcon({ size = 20, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 28 28" fill="none" className={className}>
      <path d="M7.869 4.668H20.198C20.198 4.668 19.171 20.135 14.034 20.135C11.524 20.135 9.995 16.444 9.088 12.668C8.138 8.714 7.869 4.668 7.869 4.668Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M20.198 4.668C20.198 4.668 21.273 3.521 22.166 3.501C23.916 3.461 24.24 4.668 24.24 4.668C24.582 5.379 24.856 7.228 23.213 8.934C21.569 10.641 19.728 12.134 18.98 12.668" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M7.87 4.667C7.87 4.667 6.75 3.507 5.833 3.5C4.083 3.487 3.76 4.667 3.76 4.667C3.417 5.378 3.143 7.227 4.787 8.934C6.431 10.64 8.34 12.133 9.088 12.667" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M9.925 23.333C9.925 21.2 14.035 20.133 14.035 20.133C14.035 20.133 18.144 21.2 18.144 23.333H9.925Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function ShopIcon({ size = 20, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 27 27" fill="none" className={className}>
      <path d="M3.375 11.25V21.375C3.375 22.618 4.382 23.625 5.625 23.625H21.375C22.618 23.625 23.625 22.618 23.625 21.375V11.25" stroke="currentColor" strokeWidth="1.5"/>
      <path d="M16.688 23.625V16.875C16.688 15.632 15.68 14.625 14.438 14.625H12.188C10.945 14.625 9.938 15.632 9.938 16.875V23.625" stroke="currentColor" strokeWidth="1.5" strokeMiterlimit="16"/>
      <path d="M24.546 10.535L22.64 3.865C22.557 3.575 22.292 3.375 21.991 3.375H17.438L17.972 9.792C17.99 10.002 18.104 10.191 18.285 10.299C18.723 10.56 19.581 11.044 20.25 11.25C21.393 11.602 23.063 11.475 24.015 11.358C24.411 11.309 24.655 10.918 24.546 10.535Z" stroke="currentColor" strokeWidth="1.5"/>
      <path d="M15.75 11.25C16.388 11.054 17.199 10.604 17.652 10.337C17.868 10.209 17.987 9.969 17.966 9.719L17.437 3.375H9.562L9.034 9.719C9.013 9.969 9.132 10.209 9.347 10.337C9.801 10.604 10.611 11.054 11.25 11.25C12.929 11.767 14.07 11.767 15.75 11.25Z" stroke="currentColor" strokeWidth="1.5"/>
      <path d="M4.36 3.865L2.454 10.535C2.344 10.918 2.589 11.309 2.985 11.358C3.936 11.475 5.607 11.602 6.75 11.25C7.419 11.044 8.277 10.56 8.715 10.299C8.896 10.191 9.01 10.002 9.027 9.792L9.562 3.375H5.009C4.707 3.375 4.443 3.575 4.36 3.865Z" stroke="currentColor" strokeWidth="1.5"/>
    </svg>
  );
}
...
export function CoinsIcon({ size = 20, color, className = "" }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      ...
      <path d="M14.5 9.5c-.5-1-1.5-1.5-2.5-1.5-1.38 0-2.5.9-2.5 2s1.12 2 2.5 2 2.5.9 2.5 2-1.12 2-2.5 2c-1 0-2-.5-2.5-1.5" stroke={c} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M12 6v2M12 16v2" stroke={c} strokeWidth="2" strokeLinecap="round"/>
    </svg>
  );
}
...
export function BellIcon({ size = 20, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} style={{ minWidth: size, minHeight: size }}>
      <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9Z" fill="currentColor" opacity="0.12"/>
...
export function FileTextIcon({ size = 20, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      ...
      <path d="M14 2v4a2 2 0 0 0 2 2h4M10 9H8M16 13H8M16 17H8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function SlidersIcon({ size = 20, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      <path d="M21 4H14M10 4H3M21 12H12M8 12H3M21 20H16M12 20H3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M12 2v4M10 10v4M14 18v4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  );
}

export function LayoutGridIcon({ size = 20, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
export function PackageIcon({ size = 20, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      <path d="M16.5 9.4 7.5 4.21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
export function WalletIcon({ size = 20, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      ...
      <path d="M18 12a2 2 0 0 0 0 4h4v-4h-4Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}

export function ClipboardListIcon({ size = 20, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      ...
      <path d="M12 11h4M12 16h4M8 11h.01M8 16h.01" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  );
}
...
export function OrgChartIcon({ size = 20, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      ...
      <path d="M12 6v6M5 18v-4a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
    </svg>
  );
}
...
export function FeedbackIcon({ size = 20, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
export function WishBoxIcon({ size = 20, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      <path d="M21 8v13H3V8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M23 3H1v5h22V3Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
export function SendIcon({ size = 20, className = "" }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      <path d="M22 2 11 13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="m22 2-7 20-4-9-9-4 20-7Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
